...
coco_format_save_path='/home/zecoy/datasets/GIR/RGB/annotations'                      #要生成的标准coco格式标签所在文件夹
yolo_format_classes_path='/home/zecoy/datasets/GIR/RGB/names.txt'     #类别文件，一行一个类
...
for i,imageFile in enumerate(imageFileList):
    ...
    write_json_context['images'].append(img_context)                            #将该图片信息添加到'image'列表中
                                             ...
                                             #获取该图片获取的txt文件
    txtFile = imageFile.replace('.png', '.txt')
